...
import { createMeetingSchema, getMeetingParamsSchema, listMeetingsQuerySchema } from "../validators/meetingValidator";
 ...
 */
export const getMeetingById = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        // Validate params
